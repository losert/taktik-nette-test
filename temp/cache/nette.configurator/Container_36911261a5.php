...
class Container_36911261a5 extends Nette\DI\Container
{
	...
	protected $wiring = [
		...
		'App\Presenters\ResultsPresenter' => [2 => ['application.4']],
		'App\Presenters\SurveyPresenter' => [2 => ['application.5']],
	...
	public function createServiceApplication__4(): App\Presenters\ResultsPresenter
	{
		$service = new App\Presenters\ResultsPresenter($this->getService('database.default.explorer'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('01'),
	...
	public function createServiceApplication__5(): App\Presenters\SurveyPresenter
	{
		$service = new App\Presenters\SurveyPresenter($this->getService('database.default.explorer'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('01'),
	...
	public function createServiceContainer(): Container_36911261a5
	{
		return $this;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=database;dbname=test', 'test', 'test', []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_36911261a5 $container)
			{
