...
class Container_af45c3ae39 extends Nette\DI\Container
{
	...
	public function createServiceContainer(): Container_af45c3ae39
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_af45c3ae39 $container)
			{
